...
public class Testing {
	...
	static elements pom1 =PageFactory.initElements(driver ,elements.class);
	...
	public static void sing_alon() throws InterruptedException, IOException, AWTException {
		...
		// assertEquals(sendmeKode,"שליחת קוד אימות");
	...
	//קטגוריה
	driver.findElement(By.id("input_businessCategory")).sendKeys("מדבקות");
	//שלח
	...
	public  static void rateBusiness()throws InterruptedException, IOException, AWTException{
		...
		//driver.findElement(By.id("txtCat")).sendKeys("C:\\Users\\segal\\OneDrive\\תמונות\\2.2");*/
		 boolean isselct;
